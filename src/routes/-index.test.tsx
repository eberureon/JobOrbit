...
describe('Dashboard', () => {
  beforeEach(() => {
    ...
    mocks.getStats.mockResolvedValue({
      ...
      last7Days: 2,
      last30Days: 4,
      statusBreakdown: { Applied: 2, Interview: 1, Offer: 1, Rejected: 1, Accepted: 0, Withdrawn: 0 },
  ...
  it('renders recent applications when data exists', async () => {
    mocks.listApplications.mockResolvedValue([
      { id: 1, company: 'NewCorp', role: 'Engineer', status: 'Applied', applied_date: '2026-05-20', location: '', salary: '', source: '', job_url: '', notes: '', created_at: '' },
    ])
    render(<DashboardPage />, { wrapper: Wrapper })
